...
//                .param(ps)
                ...
                .result(new Result() {
                    ...
                    public void success(String body, Response response) {
                        ...
                        for (Element e : domBody.getElementsByAttributeValue("style", "clear:both")) {
                            ...
                            System.out.println(getRealLink(link));
                        }
                    }
    ...
    public String getRealLink(String href) {
//        /url?q=http://googleweblight.com/?lite_url=http://tieba.baidu.com/f?kw%3D%25BA%25C7%25BA%25C7%25DF%25D5&ei=5u2MpO5R&lc=en&s=1&m=9&f=1&ts=1440173838&sig=APONPFn4ZRhlwQs2BM9kal-aOXJQpj_bDA&sa=U&ved=0CAoQFjABahUKEwja3rTQybrHAhVCL6YKHdYDDeo&usg=AFQjCNEoIH-U4y-4pvTJoNq36jAcJhUGmQ
